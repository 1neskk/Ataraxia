...
static void SetupVulkan(const char** extensions, uint32_t extensions_count)
{
...

	{
		...
		const char** extensions_ext = static_cast<const char**>(malloc(sizeof(const char*) * (extensions_count + 1)));
...
Application::Application(const Specs& specification)
...
VkCommandBuffer Application::submitSingleTimeCommands(VkCommandBuffer commandBuffer)
{
